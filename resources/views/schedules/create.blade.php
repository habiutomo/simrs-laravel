        ...
        <form method="POST" action="{{ route('schedules.store') }}">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="polyclinic_id" class="form-select @error('polyclinic_id') is-invalid @enderror">
                        ...
                        @foreach($polyclinics as $poli)
                            <option value="{{ $poli->id }}" {{ old('polyclinic_id')==$poli->id ? 'selected' : '' }}>{{ $poli->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="max_patients" class="form-control @error('max_patients') is-invalid @enderror" value="{{ old('max_patients') }}">
