...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('doctors.update', $item->id) }}">
            @csrf @method('PUT')
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="specialization" class="form-control @error('specialization') is-invalid @enderror" value="{{ old('specialization', $item->specialization) }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="sip" class="form-control @error('sip') is-invalid @enderror" value="{{ old('sip', $item->sip) }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="consultation_fee" class="form-control @error('consultation_fee') is-invalid @enderror" value="{{ old('consultation_fee', $item->consultation_fee) }}">
