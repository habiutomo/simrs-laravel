            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                        ...
                        <option value="dispensed" {{ old('status')=='dispensed' ? 'selected' : '' }}>Diberikan</option>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="datetime-local" name="prescribed_at" class="form-control @error('prescribed_at') is-invalid @enderror" value="{{ old('prescribed_at') }}" required>
                    ...
                    <table class="table table-sm" id="itemsTable">
                        ...
                        <tbody>
                            <tr class="item-row">
                                ...
                                <td><input type="text" name="items[0][dosage]" class="form-control form-control-sm" placeholder="Cont: 500mg"></td>
                                <td><input type="text" name="items[0][frequency]" class="form-control form-control-sm" placeholder="Cont: 3x1"></td>
                                <td><input type="text" name="items[0][instruction]" class="form-control form-control-sm" placeholder="Sesudah makan"></td>
