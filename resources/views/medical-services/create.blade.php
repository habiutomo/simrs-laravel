...
@section('content')
<div class="card">
    <div class="card-header">Tambah Layanan Medis</div>
    <div class="card-body">
        <form method="POST" action="{{ route('medical-services.store') }}">
            @csrf
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="category" class="form-select @error('category') is-invalid @enderror">
                        ...
                        <option value="Tindakan" {{ old('category')=='Tindakan' ? 'selected' : '' }}>Tindakan</option>
