...
<div class="card">
    <div class="card-body">
        ...
        @endphp
        <form method="POST" action="{{ route('patient-bills.store') }}">
            @csrf
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="discount" class="form-control @error('discount') is-invalid @enderror" value="{{ old('discount', 0) }}" min="0">
