...
<div class="page-header">
    <h5 class="mb-0">Tambah Rujukan</h5>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="from_doctor_id" class="form-select @error('from_doctor_id') is-invalid @enderror" required>
                        ...
                        <option value="{{ $doctor->id }}" {{ old('from_doctor_id')==$doctor->id ? 'selected' : '' }}>{{ $doctor->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="to_institution" class="form-control @error('to_institution') is-invalid @enderror" value="{{ old('to_institution') }}" required>
                    @error('to_institution')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">Dokter Tujuan</label>
                    <input type="text" name="to_doctor" class="form-control @error('to_doctor') is-invalid @enderror" value="{{ old('to_doctor') }}">
                    @error('to_doctor')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">Tanggal Rujukan</label>
                    <input type="date" name="referral_date" class="form-control @error('referral_date') is-invalid @enderror" value="{{ old('referral_date') }}" required>
