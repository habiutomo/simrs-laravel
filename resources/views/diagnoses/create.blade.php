...
@section('content')
<div class="card">
    <div class="card-header">Tambah Diagnosis</div>
    <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="category" class="form-select @error('category') is-invalid @enderror">
                        ...
                        <option value="ICD-10" {{ old('category')=='ICD-10' ? 'selected' : '' }}>ICD-10</option>
                        <option value="ICD-9" {{ old('category')=='ICD-9' ? 'selected' : '' }}>ICD-9</option>
