...
@section('content')
<div class="card">
    <div class="card-header">Tambah Asuransi</div>
    <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="type" class="form-select @error('type') is-invalid @enderror">
                        ...
                        <option value="Asuransi" {{ old('type')=='Asuransi' ? 'selected' : '' }}>Asuransi</option>
                        <option value="Perusahaan" {{ old('type')=='Perusahaan' ? 'selected' : '' }}>Perusahaan</option>
                        <option value="JKN" {{ old('type')=='JKN' ? 'selected' : '' }}>JKN</option>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="coverage_percentage" class="form-control @error('coverage_percentage') is-invalid @enderror" value="{{ old('coverage_percentage') }}">
