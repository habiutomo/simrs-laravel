@extends('layouts.app')
@section('title', 'Edit Kelas Kamar')
@section('content')
<div class="card">
    <div class="card-header">Edit Kelas Kamar</div>
    <div class="card-body">
        <form method="POST" action="{{ route('room-categories.update', $item->id) }}">
            @csrf @method('PUT')
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="rate_per_day" class="form-control @error('rate_per_day') is-invalid @enderror" value="{{ old('rate_per_day', $item->rate_per_day) }}">
            ...
            <div class="d-flex justify-content-end gap-2 mt-3">
                <a href="{{ route('room-categories.index') }}" class="btn btn-secondary">Batal</a>
